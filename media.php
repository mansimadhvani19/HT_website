                        ...
                        <nav class="main-menu navbar-expand-md">
                            ...
                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current dropdown"><a href="media.php">Media</a>
                                    </li>
            ...
            <div class="content-box">
                ...
                <div class="row two-column">
                    <div class="column col-lg-6 col-md-12 order-2">                
                        <figure class="image"><img src="images/SOCIAL MEDIA 473X272-01.jpg" alt=""></figure>
                    </div>
               <h4>Media</h4>
                    ...
                    <div class="column col-lg-6 col-md-12">                
                        ...
                        <ul class="list-style-one">
                            <li>Media</li>
                            <li>Print Media.</li>
                            <li>Electronic/Broadcasting Media.</li>
                            <li>Outdoor Media or Out of Home Media </li>
                            <li>Transit Media.</li>
                            <li>Digital Media/New Media/Internet</li>
                        </ul>
                    </div>
                </div>
